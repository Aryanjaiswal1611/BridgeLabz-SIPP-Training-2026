...
public class Scenario6_BuildDependencyCycle {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Tasks 1 (linear) has cycle: " + hasCircularDependency(tasks1, 4));
        ...
        System.out.println("Tasks 2 (cycle) has cycle: " + hasCircularDependency(tasks2, 3));
