...
public class Scenario5_CircuitCycleDetection {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Circuit 1 (tree) has loop: " + hasWiringLoop(circuit1, 4));
        ...
        System.out.println("Circuit 2 (triangle) has loop: " + hasWiringLoop(circuit2, 3));
        ...
        System.out.println("Circuit 3 (square with diagonal) has loop: " + hasWiringLoop(circuit3, 4));
    }
}
