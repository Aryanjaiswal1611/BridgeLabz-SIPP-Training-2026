...
public class Scenario4_NetworkSegments {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Network 1 segments: " + segments1 + " (fully connected: " + (segments1 == 1) + ")");
        ...
        System.out.println("Network 2 segments: " + segments2 + " (fully connected: " + (segments2 == 1) + ")");
    }
}
